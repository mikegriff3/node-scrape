...
casper.thenOpen(url, function() {
  // if (this.exists('//td[@class="player"]')) {
...
var getPlayerBasicStats = function() {
  var rows = document.querySelectorAll("div.nba-stat-table tr");
  var players = rows.length;
...
function outputToCsv(statsArr) {
  ...
  var fileName = "player-csv/player-basic-stats.csv";
