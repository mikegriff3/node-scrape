...
var getGameInfo = function() {
  ...
  game.Away_FG = team_totals[1].innerText;
  game.Away_FGA = team_totals[2].innerText;
  game.Away_3P = team_totals[4].innerText;
  game.Away_3PA = team_totals[5].innerText;
  game.Away_FTM = team_totals[7].innerText;
  game.Away_FTA = team_totals[8].innerText;
  game.Away_ORB = team_totals[10].innerText;
  game.Away_TRB = team_totals[12].innerText;
  game.Away_AST = team_totals[13].innerText;
  game.Away_STL = team_totals[14].innerText;
  game.Away_ORB_PCT = team_totals[25].innerText;
  game.Away_BLK_PCT = team_totals[30].innerText;
  game.Away_TOV_PCT = team_totals[31].innerText;

  game.Home_FG = team_totals[1 + 35].innerText;
  game.Home_FGA = team_totals[2 + 35].innerText;
  game.Home_3P = team_totals[4 + 35].innerText;
  game.Home_3PA = team_totals[5 + 35].innerText;
  game.Home_FTM = team_totals[7 + 35].innerText;
  game.Home_FTA = team_totals[8 + 35].innerText;
  game.Home_ORB = team_totals[10 + 35].innerText;
  game.Home_TRB = team_totals[12 + 35].innerText;
  game.Home_AST = team_totals[13 + 35].innerText;
  game.Home_STL = team_totals[14 + 35].innerText;
  game.Home_ORB_PCT = team_totals[25 + 35].innerText;
  game.Home_BLK_PCT = team_totals[30 + 35].innerText;
  game.Home_TOV_PCT = team_totals[31 + 35].innerText;
